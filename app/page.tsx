...
import { FlashXLogo } from '@/app/ui/flashx-logo';
    ...
    <main className="flex min-h-screen flex-col p-6">
      ...
      <div className="mt-2 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-3/6 md:px-20">
          ...
          <ul className={`${lusitana.className} ml-5 antialiased`}>
            <li>Hai Nam Nguyen - 000520322 - nguyen0465@saskpolytech.ca </li>
            <li>
              Cong Chi Tai Nguyen - 000516006 - nguyen6169@saskpolytech.ca
            </li>
            <li>Xuan Hieu Nguyen - 000518043 - nguyen8191@saskpolytech.ca </li>
          </ul>
          <Link
            href="/login"
